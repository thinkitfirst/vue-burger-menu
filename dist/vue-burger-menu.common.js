...
/* harmony default export */ var Menuvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    documentClick: function documentClick(e) {
      ...
      if (triggers.indexOf(eleName.toLowerCase()) > -1 && !this.closest(target, '.bm-item-list') && target.className !== 'bm-menu' && this.isSideBarOpen) {
        if (this.isSearchMenu) {
...
var component = normalizeComponent(
  ...
  Menuvue_type_template_id_bed1eade_render,
  Menuvue_type_template_id_bed1eade_staticRenderFns,
  false,
  null,
  null,
  null
