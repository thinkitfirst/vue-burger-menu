...
/* harmony default export */ var Menuvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    documentClick: function documentClick(e) {
      ...
      var searchEle = document.querySelector('.bm-search-icon');
      var target = e.target;

      if (!this.closest(element, '.bm-item-list') && !this.closest(searchEle, '.bm-item-list') && target.className !== 'bm-menu' && this.isSideBarOpen) {
        this.closeMenu();
      }
    },
...
var component = normalizeComponent(
  ...
  Menuvue_type_template_id_77485a84_render,
  Menuvue_type_template_id_77485a84_staticRenderFns,
  false,
  null,
  null,
  null
