...
/* harmony default export */ var Menuvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    documentClick: function documentClick(e) {
      ...
      var isTriggeredEle = triggers.indexOf(eleName.toLowerCase()) > -1 || triggers.indexOf(target.parentNode.nodeName.toLowerCase()) > -1;

      if ((isTriggeredEle || !this.closest(target, '.bm-item-list')) && target.className !== 'bm-menu' && this.isSideBarOpen) {
        if (this.isSearchMenu) {
...
var component = normalizeComponent(
  ...
  Menuvue_type_template_id_3c2aa11b_render,
  Menuvue_type_template_id_3c2aa11b_staticRenderFns,
  false,
  null,
  null,
  null
